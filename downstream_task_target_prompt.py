...
if __name__ == "__main__":
    ...
    if args.task == 'NodeTask':
        tasker_target = NodeTask(pre_train_model_path = args.pre_train_model_path, 
                        ...
                        batch_size = args.batch_size, seed = int(42+args.seed), data = data, input_dim = input_dim, output_dim = output_dim, graphs_list = graphs_list, use_different_dataset=args.use_different_dataset, pre_train_data=args.pre_train_data)
        pre_train_type = tasker_target.pre_train_type
        train_idx = tasker_target.train_idx
        test_idx = tasker_target.test_idx
    ...
    #                         batch_size = args.batch_size, seed=args.seed, data = data, input_dim = input_dim, output_dim = output_dim, graphs_list = graphs_list, use_different_dataset=args.use_different_dataset, train_idx=train_idx, test_idx=test_idx)
